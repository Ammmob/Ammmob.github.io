    ...
    <section class="publications section" id="publications">
      ...
      <div class="publication-list">
        <article class="publication-item">
          <a class="paper-thumb" href="https://ammmob.github.io/PixelSmile/" target="_blank" rel="noreferrer" aria-label="Visit the PixelSmile project page"><img src="assets/images/publications/pixelsmile/teaser.webp" alt="PixelSmile teaser" loading="lazy"></a>
        ...
        <article class="publication-item">
          <a class="paper-thumb paper-collage" href="https://xsafeai.github.io/AI-safety-report/" target="_blank" rel="noreferrer" aria-label="Visit the AI Safety Report project page">
            <img src="assets/images/publications/ai-safety-report/spec_1.webp" alt="" loading="lazy">
            <img src="assets/images/publications/ai-safety-report/spec_3.webp" alt="" loading="lazy">
            <img src="assets/images/publications/ai-safety-report/spec_4.webp" alt="" loading="lazy">
            <img src="assets/images/publications/ai-safety-report/spec_5.webp" alt="" loading="lazy">
            <img src="assets/images/publications/ai-safety-report/spec_6.webp" alt="" loading="lazy">
            <img src="assets/images/publications/ai-safety-report/spec_7.webp" alt="" loading="lazy">
          </a>
