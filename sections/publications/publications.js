    ...
    <section class="publications section" id="publications">
      ...
      <div class="publication-list">
        <article class="publication-item">
          <a class="paper-thumb" href="https://ammmob.github.io/PixelSmile/" target="_blank" rel="noreferrer" aria-label="Visit the PixelSmile project page"><img src="assets/images/pixelsmile-teaser.png" alt="PixelSmile teaser" loading="lazy"></a>
        ...
        <article class="publication-item">
          <a class="paper-thumb paper-collage" href="https://xsafeai.github.io/AI-safety-report/" target="_blank" rel="noreferrer" aria-label="Visit the AI Safety Report project page">
            <img src="assets/images/safety-report/spec_1.png" alt="" loading="lazy">
            <img src="assets/images/safety-report/spec_3.png" alt="" loading="lazy">
            <img src="assets/images/safety-report/spec_4.png" alt="" loading="lazy">
            <img src="assets/images/safety-report/spec_5.png" alt="" loading="lazy">
            <img src="assets/images/safety-report/spec_6.png" alt="" loading="lazy">
            <img src="assets/images/safety-report/spec_7.png" alt="" loading="lazy">
          </a>
